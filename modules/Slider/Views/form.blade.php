                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('content['.$i.'][language]['. $language['locale'] .'][title]', @$content['language'][$language['locale']]['title'], ['class' => 'form-control', 'required']) !!}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            {!! Form::number('content['.$i.'][position]', @$content['position'], ['class' => 'form-control', 'required']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="form-group">
                    ...
                    <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ $language['locale'] }}___KEY__">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form_group">
                                    <div class="choose-thumbnail">
                                        {!! Form::hidden('content[__KEY__][language]['. $language['locale'] .'][picture]', null, ['id' => 'content_' . $i . '_' . $language['locale']]) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                 <div class="form-group">
                                    {!! Form::label('description', trans('language.title'), ['class' => 'label-control']) !!}
                                    {!! Form::text('content[__KEY__][language]['. $language['locale'] .'][title]', null, ['class' => 'form-control', 'required']) !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('description', trans('language.description'), ['class' => 'label-control']) !!}
