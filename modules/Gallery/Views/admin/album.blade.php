            ...
            @foreach(config('cnv.languages') as $language)
                ...
                <div class="tab-pane {{ $loop->first ? 'active' : '' }}" id="{{ $language['locale'] }}_album">
                    ...
                    <div class="text-right">
                        <button class="btn btn-success" type="button" onclick="addLineContent('{{ $language['locale'] }}');">
                            <i class="fa fa-plus"></i>
                        </button>
                        <button class="btn btn-danger" type="button" onclick="removeLineContent('{{ $language['locale'] }}');">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::number('language['.$language['locale'].'][content]['.$i.'][position]', @$item['position'], ['class' => 'form-control', 'required']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
...
<div class="hidden" id="lineTemplate" data-template='
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="form_group">
                <div class="choose-thumbnail">
                    {!! Form::hidden('language[__LANG__][content][__KEY__][picture]', null, ['id' => 'content_' . $i . '_' . $language['locale']]) !!}
                </div>
            </div>
        </div>
        <div class="col-lg-8">
            ...
            <div class="form-group">
                {!! Form::label('description', trans('language.description'), ['class' => 'label-control']) !!}
                {!! Form::textarea('language[__LANG__][content][__KEY__][description]', null, ['class' => 'form-control', 'rows' => 5]) !!}
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        {!! Form::label('position', trans('language.position'), ['class' => 'label-control']) !!}
                        {!! Form::number('language[__LANG__][content][__KEY__][position]', '__KEY__', ['class' => 'form-control', 'required']) !!}
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
